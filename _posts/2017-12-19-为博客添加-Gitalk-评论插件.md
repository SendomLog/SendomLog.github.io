...
subtitle: SendomLog Blog 添加 Gitalk 的评论插件了
date: 2017-12-19
author: SendomLog
...
由于 **Disqus** 对于国内网路的支持十分糟糕，很多人反映 Disqus 评论插件一直加载不出来。而我一直是处于翻墙状态的~（话说你们做程序员的都不翻墙用 Google 的吗 😅，哈哈，吐嘈下）
...
当然，你也可以手动创建 issue 作为 gitalk 评论容器。只要有 `Gitalk` 标签 和 `id` 对应标签就可以。比我我自己创建的 [About issue](https://github.com/SendomLog/SendomLog.github.io/issues/38) 。
...
最后，[给个 star 吧](https://github.com/SendomLog/SendomLog.github.io)~
