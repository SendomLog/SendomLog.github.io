...
需要实现的代码就是要这么多，但这些代码写在 ViewController 显得太臃肿了，所以我对代码进行了封装:

```
//
//  BYPhoneNumTF.h
//
//  Created by SendomLog on 16/12/2.
//  Copyright © 2016年 SendomLog. All rights reserved.
...
在 storyboard 中的`TextField`控件的 Calss 类型选择该类`BYPhoneNumTF`即可。

代码及 Demo 下载地址：[BYPhoneNumTF](https://github.com/SendomLog/BYPhoneNumTF)
